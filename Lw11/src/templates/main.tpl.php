  ...
  <body>
    <header>
      <div class="header_button_block">
        <button type="button" name="button" class="about_me"><img src="images/about_me_icon.png" alt="about_me_icon">Обо мне</button>
        <button type="button" name="button" class="my_hobby"><img src="images/hobby_icon.png" alt="about_me_icon">Мое хобби</button>
        <button type="button" name="button" class="loved_film"><img src="images/video_icon.png" alt="about_me_icon">Любимые фильмы</button>
      </div>
    </header>
    <div class="info">
      ...
      <div class="base">
        <div class="photo_plus_quot">
          <div class="user_photo">
            <img src="images/ivan.jpg" alt="user_photo">
          </div>
          <div class="quot">
            <p>
              Мы берем на себя много, потому что мало чего боимся<br>
            </p>
            <span>— Том Демарко. Deadline</span>
          </div>
        </div>
        <div class="sidebar">
        ...
        <div class="text">
          ...
          <p>
            В 1930-е годы прошлого века физик Джордж Гамоу
            из университета штата Колорадо начал публиковать<br>
          ...
          <span>Мое хобби</span>
          <p>
            Он регулярно посещал вечерние лекции местного профессора и, разумеется, всегда засыпал на самом интересном месте.<br>
          ...
          <a href="https://vk.com/mukiva">Напиши мне <span>→</span></a>
        </div>
      </div>
      ...
      <div class="carousel">
        <button type="button" name="right_event" id="right_event">
          <img class="nofilter_img" alt="right_arrow_img" src="images/right_arrow_button.png">
        </button>
        <button type="button" name="left_event" id="left_event">
          <img class="nofilter_img" alt="left_arrow_img" src="images/left_arrow_button.png">
        </button>
        <div class="film">
          <div class="film1">
            <img alt="user" src="images/movie_one.png" class="photo">
          ...
          <div class="film2">
            <img alt="user" src="images/movie_two.png" class="photo">
            <span>Наркоз</span>
            <p>
          ...
          <div class="film3">
            <img alt="user" src="images/movie_third.png" class="photo">
            <span>Астрал</span>
            <p>
          ...
          <div class="film4">
            <img alt="user" src="images/movie_fourth.png" class="photo">
            <span>Гравитация</span>
            <P>
              Доктор Райан Стоун, блестящий специалист в области медицинского инжиниринга, отправляется в свою первую космическую миссию под командованием ветерана астронавтики Мэтта Ковальски, для которого этот полет — последний перед отставкой. Но во время, казалось бы, рутинной работы за бортом случается катастрофа.<br>
          ...
          <div class="hidden_block">
            <img alt="user" src="images/movie_five.png" class="photo">
            <span>Джокер</span>
            <P>
          ...
          <div class="hidden_block">
            <img alt="user" src="images/movie_six.png" class="photo">
            <span>Война миров</span>
            <P>
          ...
          <div class="hidden_block">
            <img alt="user" src="images/movie_seven.png" class="photo">
            <span>Аватар</span>
            <P>
          ...
          <div class="hidden_block">
            <img alt="user" src="images/movie_eight.png" class="photo">
            <span>Оно</span>
            <P>
          ...
          <div class="hidden_block">
            <img alt="user" src="images/movie_nine.png" class="photo">
          ...
          <div class="hidden_block">
            <img alt="user" src="images/movie_ten.png" class="photo">
            <span>Звездные войны</span>
            <P>
              Звёздные во́йны (Star Wars) — фантастическая сага, задуманная американским режиссёром Джорджем Лукасом в начале 1970-х годов и позднее расширенная. В неё входят фильмы, мультсериалы, книги, компьютерные игры.
            </P>
          </div>
        </div>
        <button type="button" name="button" id="film_button">Все фильмы</button>
      </div>
